...
const service = read('runtime-installers/windows/PartnersInBizRuntime.xml')
...
requireText('Windows', win, /Register-ScheduledTask/)
requireText('Windows service', service, /PartnersInBizRuntime/)
requireText('Windows service', service, /BootTrigger/)
