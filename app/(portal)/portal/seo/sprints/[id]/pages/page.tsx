  ...
  return (
    <div className="space-y-4" data-module-accent="green">
      <section className="flex items-end justify-between gap-4 flex-wrap border-b border-[var(--color-pib-line)] pb-4">
        <div>
          <p className="sc-tiny">Page performance</p>
          <h2 className="text-lg mt-1">Pages</h2>
      ...
      {pages.length === 0 ? (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
          {pages.map((page) => (
            <article key={page.url} className="st-panel p-5">
              <div className="flex items-start justify-between gap-4">
                <div className="min-w-0">
                  <p className="sc-tiny !text-[10px]">Tracked page</p>
                  <a href={page.url} target="_blank" rel="noopener" className="font-headline text-lg mt-2 block truncate hover:text-[var(--color-pib-accent)]">
