          ...
          <div className="flex flex-wrap items-end gap-2 rounded-[var(--st-radius-raised)] border border-[var(--color-pib-line)] bg-[var(--color-pib-surface-soft)] p-3">
            <div className="min-w-[180px] flex-1">
              ...
              <input
                ...
                className="mt-1 h-8 w-full rounded-md border border-[var(--color-pib-line)] bg-transparent px-2 text-xs"
              />
            </div>
            <button
              type="button"
              ...
              <div className="mt-3 space-y-2 rounded-[var(--st-radius-raised)] border border-[var(--color-pib-line)] bg-[var(--color-pib-surface-soft)] p-3">
                ...
                <div className="flex flex-wrap gap-2">
                  <select
                    ...
                    className="h-8 min-w-[220px] flex-1 rounded-md border border-[var(--color-pib-line)] bg-transparent px-2 text-xs"
                  >
                ...
                <thead>
                  <tr className="border-b" style={{ borderColor: 'var(--color-pib-line)' }}>
                    {['Item', 'Qty', 'Unit price', 'Total'].map(h => (
                      <th
                        key={h}
                        className="text-left pib-label px-4 py-2.5"
                      >
                        {h}
                      </th>
                    ))}
