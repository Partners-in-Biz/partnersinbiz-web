      ...
      <section className="px-8 md:px-16 pb-32 max-w-4xl">
        <div className="space-y-12 font-body text-white/60 leading-relaxed">
          ...
          <div className="glass-card p-8 rounded-md">
            <h2 className="font-headline text-2xl font-medium text-white mb-4">1. Information We Collect</h2>
            <p className="mb-4">
          ...
          <div className="glass-card p-8 rounded-md">
            <h2 className="font-headline text-2xl font-medium text-white mb-4">2. How We Use Your Information</h2>
          ...
          <div className="glass-card p-8 rounded-md">
            <h2 className="font-headline text-2xl font-medium text-white mb-4">3. Sharing of Information</h2>
            <p>
          ...
          <div className="glass-card p-8 rounded-md">
            <h2 className="font-headline text-2xl font-medium text-white mb-4">4. Data Retention</h2>
            <p>
          ...
          <div className="glass-card p-8 rounded-md">
            <h2 className="font-headline text-2xl font-medium text-white mb-4">5. Your Rights</h2>
            <p className="mb-4">
          ...
          <div className="glass-card p-8 rounded-md">
            <h2 className="font-headline text-2xl font-medium text-white mb-4">6. Cookies</h2>
            <p>
          ...
          <div className="glass-card p-8 rounded-md">
            <h2 className="font-headline text-2xl font-medium text-white mb-4">7. Security, Access Controls, and Auditability</h2>
            <p>
          ...
          <div className="glass-card p-8 rounded-md">
            <h2 className="font-headline text-2xl font-medium text-white mb-4">8. AI-Assisted Processing and Sensitive Information</h2>
            <p>
          ...
          <div className="glass-card p-8 rounded-md">
            <h2 className="font-headline text-2xl font-medium text-white mb-4">9. Changes to This Policy</h2>
            <p>
          ...
          <div className="glass-card p-8 rounded-md">
            <h2 className="font-headline text-2xl font-medium text-white mb-4">10. Contact</h2>
            <p>
