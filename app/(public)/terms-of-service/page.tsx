  ...
  return (
    <main>
      <header className="relative min-h-[40vh] flex flex-col justify-center px-8 md:px-16 pt-32 pb-20 overflow-hidden">
        <div className="absolute top-1/4 -right-1/4 w-96 h-96 bg-white/5 rounded-md blur-[120px]"></div>
        <div className="max-w-6xl relative z-10">
          <p className="font-label text-[0.6875rem] uppercase tracking-widest text-white/40 mb-6">Legal</p>
          <h1 className="font-headline text-6xl md:text-[6.5rem] leading-[0.9] font-medium tracking-tighter mb-10">
            TERMS OF<br />SERVICE
          </h1>
      ...
      <section className="px-8 md:px-16 pb-32 max-w-4xl">
        <div className="space-y-12 font-body text-white/60 leading-relaxed">
          ...
          <div className="glass-card p-8 rounded-md">
            <h2 className="font-headline text-2xl font-medium text-white mb-4">1. Acceptance of Terms</h2>
            <p>
          ...
          <div className="glass-card p-8 rounded-md">
            <h2 className="font-headline text-2xl font-medium text-white mb-4">2. Services</h2>
            <p className="mb-4">
          ...
          <div className="glass-card p-8 rounded-md">
            <h2 className="font-headline text-2xl font-medium text-white mb-4">3. Client Responsibilities</h2>
            <ul className="space-y-3 list-none">
              {[
                ...
                <li key={item} className="flex items-start gap-3">
                  <span className="mt-1 w-1 h-1 rounded-md bg-white/30 flex-shrink-0 block"></span>
                  {item}
                </li>
              ))}
            </ul>
          ...
          <div className="glass-card p-8 rounded-md">
            <h2 className="font-headline text-2xl font-medium text-white mb-4">4. Intellectual Property</h2>
            <p className="mb-4">
          ...
          <div className="glass-card p-8 rounded-md">
            <h2 className="font-headline text-2xl font-medium text-white mb-4">5. Payment Terms</h2>
            <p className="mb-4">
          ...
          <div className="glass-card p-8 rounded-md">
            <h2 className="font-headline text-2xl font-medium text-white mb-4">6. Confidentiality</h2>
            <p>
          ...
          <div className="glass-card p-8 rounded-md">
            <h2 className="font-headline text-2xl font-medium text-white mb-4">7. AI, Safety, and Professional Advice Boundaries</h2>
            <p className="mb-4">
          ...
          <div className="glass-card p-8 rounded-md">
            <h2 className="font-headline text-2xl font-medium text-white mb-4">8. Access Controls and Auditability</h2>
            <p>
          ...
          <div className="glass-card p-8 rounded-md">
            <h2 className="font-headline text-2xl font-medium text-white mb-4">9. Limitation of Liability</h2>
            <p className="mb-4">
          ...
          <div className="glass-card p-8 rounded-md">
            <h2 className="font-headline text-2xl font-medium text-white mb-4">10. Termination</h2>
            <p>
          ...
          <div className="glass-card p-8 rounded-md">
            <h2 className="font-headline text-2xl font-medium text-white mb-4">11. Governing Law</h2>
            <p>
          ...
          <div className="glass-card p-8 rounded-md">
            <h2 className="font-headline text-2xl font-medium text-white mb-4">12. Contact</h2>
            <p>
