          ...
          data: {
            proof: {
              ...
              checks: [
                ...
                { id: 'completed_run_artifacts', label: 'Completed run artifacts', status: 'blocked', evidence: '0/0 completed runs have output URL, artifact ID, or text preview evidence.' },
                ...
                { id: 'repeated_job_reliability', label: 'Repeated creative job reliability', status: 'warning', evidence: '2 total runs, 0 artifact-backed completed, 0 completed missing artifacts, 1 active, 1 failed, 100% artifact-backed failure rate, 1 stale active.' },
              ],
            },
          },
        }),
