  ...
  return (
    <div className="space-y-6">
      ...
      <Surface className="p-5">
        <div className="flex items-start justify-between gap-4">
          <div>
            ...
            <h2 className="mt-2 text-lg font-semibold text-[var(--color-pib-text)]">Who can use Mobile Apps</h2>
      ...
      <Surface className="p-5">
        <div className="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
          <div>
            ...
            <h2 className="mt-2 text-lg font-semibold text-[var(--color-pib-text)]">Default mobile app templates plus organisation custom templates</h2>
            <p className="mt-1 max-w-2xl text-sm leading-relaxed text-[var(--color-pib-text-muted)]">
      ...
      <Surface className="p-5">
        ...
        <h2 className="mt-2 text-lg font-semibold text-[var(--color-pib-text)]">What app owners control inside an app profile</h2>
