  ...
  return (
    <div data-testid="bot-rail-dock" className="relative shrink-0 border-t border-[var(--color-pib-line)] pt-1">
      {pluginsOpen && (
        ...
        >
          <p className="px-1 pb-1.5 text-[10px] font-label uppercase tracking-[0.16em] text-[var(--color-pib-text-muted)]">{BOT_MODE_COPY.capabilitiesLabel}</p>
          ...
          <p className="mt-2 px-1 pb-1 text-[10px] font-label uppercase tracking-[0.16em] text-[var(--color-pib-text-muted)]">{BOT_MODE_COPY.contextLabel}</p>
