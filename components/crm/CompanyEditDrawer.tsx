...
function Field({ label, htmlFor, required, error, children }: {
  ...
  return (
    <div className="space-y-1">
      <label htmlFor={htmlFor} className="block text-[11px] font-label text-on-surface-variant">
      ...
      <div className="relative flex h-full w-full max-w-lg flex-col overflow-hidden border-l border-[var(--color-card-border)] bg-[var(--color-card)]">
        ...
        <div className="flex h-11 shrink-0 items-center justify-between border-b border-[var(--color-card-border)] px-4">
          ...
          <button
            ...
            onClick={onClose}
            className="grid h-8 w-8 cursor-pointer place-items-center rounded-md text-on-surface-variant transition-colors hover:bg-white/[0.05] hover:text-on-surface"
          >
        ...
        <form onSubmit={handleSubmit} className="min-h-0 flex-1 overflow-y-auto px-4 py-3 space-y-3">
          ...
          <Field label="Company Name" htmlFor="co-name" required error={errors.name}>
            <input
              ...
              value={form.name}
              onChange={set('name')}
              className="h-9 w-full rounded-md border border-[var(--color-card-border)] bg-transparent px-2.5 text-sm text-on-surface placeholder:text-on-surface-variant/60 focus:outline-none focus:border-white/25"
          ...
          <Field label="Phone" htmlFor="co-phone">
            <input id="co-phone" type="text" value={form.phone} onChange={set('phone')} className="h-9 w-full rounded-md border border-[var(--color-card-border)] bg-transparent px-2.5 text-sm text-on-surface placeholder:text-on-surface-variant/60 focus:outline-none focus:border-white/25" placeholder="+27 21 000 0000" />
          </Field>

          {/* Legal & billing */}
          <Section title="Legal & Billing" />
          <Field label="Legal Name" htmlFor="co-legal-name">
            <input id="co-legal-name" type="text" value={form.legalName} onChange={set('legalName')} className="h-9 w-full rounded-md border border-[var(--color-card-border)] bg-transparent px-2.5 text-sm text-on-surface placeholder:text-on-surface-variant/60 focus:outline-none focus:border-white/25" placeholder="ACME (Pty) Ltd" />
          </Field>
          <Field label="Trading Name" htmlFor="co-trading-name">
            <input id="co-trading-name" type="text" value={form.tradingName} onChange={set('tradingName')} className="h-9 w-full rounded-md border border-[var(--color-card-border)] bg-transparent px-2.5 text-sm text-on-surface placeholder:text-on-surface-variant/60 focus:outline-none focus:border-white/25" placeholder="ACME" />
          </Field>
          <div className="grid grid-cols-2 gap-2">
            <Field label="Registration Number" htmlFor="co-registration-number">
              <input id="co-registration-number" type="text" value={form.registrationNumber} onChange={set('registrationNumber')} className="h-9 w-full rounded-md border border-[var(--color-card-border)] bg-transparent px-2.5 text-sm text-on-surface placeholder:text-on-surface-variant/60 focus:outline-none focus:border-white/25" placeholder="2020/000000/07" />
            </Field>
            <Field label="VAT Number" htmlFor="co-vat-number">
              <input id="co-vat-number" type="text" value={form.vatNumber} onChange={set('vatNumber')} className="h-9 w-full rounded-md border border-[var(--color-card-border)] bg-transparent px-2.5 text-sm text-on-surface placeholder:text-on-surface-variant/60 focus:outline-none focus:border-white/25" placeholder="4000000000" />
            </Field>
          </div>
          <div className="grid grid-cols-2 gap-2">
            <Field label="Tax Number" htmlFor="co-tax-number">
              <input id="co-tax-number" type="text" value={form.taxNumber} onChange={set('taxNumber')} className="h-9 w-full rounded-md border border-[var(--color-card-border)] bg-transparent px-2.5 text-sm text-on-surface placeholder:text-on-surface-variant/60 focus:outline-none focus:border-white/25" />
            </Field>
            <Field label="Billing Email" htmlFor="co-billing-email">
              <input id="co-billing-email" type="email" value={form.billingEmail} onChange={set('billingEmail')} className="h-9 w-full rounded-md border border-[var(--color-card-border)] bg-transparent px-2.5 text-sm text-on-surface placeholder:text-on-surface-variant/60 focus:outline-none focus:border-white/25" placeholder="accounts@company.com" />
            </Field>
          </div>
          <Field label="Billing Street Address" htmlFor="co-billing-line1">
            <input id="co-billing-line1" type="text" value={form.billingLine1} onChange={set('billingLine1')} className="h-9 w-full rounded-md border border-[var(--color-card-border)] bg-transparent px-2.5 text-sm text-on-surface placeholder:text-on-surface-variant/60 focus:outline-none focus:border-white/25" />
          </Field>
          <Field label="Billing Address Line 2" htmlFor="co-billing-line2">
            <input id="co-billing-line2" type="text" value={form.billingLine2} onChange={set('billingLine2')} className="h-9 w-full rounded-md border border-[var(--color-card-border)] bg-transparent px-2.5 text-sm text-on-surface placeholder:text-on-surface-variant/60 focus:outline-none focus:border-white/25" />
          </Field>
          <div className="grid grid-cols-2 gap-2">
            <Field label="Billing City" htmlFor="co-billing-city">
              <input id="co-billing-city" type="text" value={form.billingCity} onChange={set('billingCity')} className="h-9 w-full rounded-md border border-[var(--color-card-border)] bg-transparent px-2.5 text-sm text-on-surface placeholder:text-on-surface-variant/60 focus:outline-none focus:border-white/25" />
            </Field>
            <Field label="Billing State / Province" htmlFor="co-billing-state">
              <input id="co-billing-state" type="text" value={form.billingState} onChange={set('billingState')} className="h-9 w-full rounded-md border border-[var(--color-card-border)] bg-transparent px-2.5 text-sm text-on-surface placeholder:text-on-surface-variant/60 focus:outline-none focus:border-white/25" />
            </Field>
          </div>
          <div className="grid grid-cols-2 gap-2">
            <Field label="Billing Postal Code" htmlFor="co-billing-postal-code">
              <input id="co-billing-postal-code" type="text" value={form.billingPostalCode} onChange={set('billingPostalCode')} className="h-9 w-full rounded-md border border-[var(--color-card-border)] bg-transparent px-2.5 text-sm text-on-surface placeholder:text-on-surface-variant/60 focus:outline-none focus:border-white/25" />
            </Field>
            <Field label="Billing Country" htmlFor="co-billing-country">
              <input id="co-billing-country" type="text" value={form.billingCountry} onChange={set('billingCountry')} className="h-9 w-full rounded-md border border-[var(--color-card-border)] bg-transparent px-2.5 text-sm text-on-surface placeholder:text-on-surface-variant/60 focus:outline-none focus:border-white/25" />
            </Field>
          </div>
          ...
          <div className="grid grid-cols-2 gap-2">
            <Field label="Accounts Contact Name" htmlFor="co-accounts-name">
              <input id="co-accounts-name" type="text" value={form.accountsContactName} onChange={set('accountsContactName')} className="h-9 w-full rounded-md border border-[var(--color-card-border)] bg-transparent px-2.5 text-sm text-on-surface placeholder:text-on-surface-variant/60 focus:outline-none focus:border-white/25" />
            </Field>
            <Field label="Accounts Contact Title" htmlFor="co-accounts-title">
              <input id="co-accounts-title" type="text" value={form.accountsContactTitle} onChange={set('accountsContactTitle')} className="h-9 w-full rounded-md border border-[var(--color-card-border)] bg-transparent px-2.5 text-sm text-on-surface placeholder:text-on-surface-variant/60 focus:outline-none focus:border-white/25" />
            </Field>
          </div>
          <div className="grid grid-cols-2 gap-2">
            <Field label="Accounts Contact Email" htmlFor="co-accounts-email">
              <input id="co-accounts-email" type="email" value={form.accountsContactEmail} onChange={set('accountsContactEmail')} className="h-9 w-full rounded-md border border-[var(--color-card-border)] bg-transparent px-2.5 text-sm text-on-surface placeholder:text-on-surface-variant/60 focus:outline-none focus:border-white/25" />
            </Field>
            <Field label="Accounts Contact Phone" htmlFor="co-accounts-phone">
              <input id="co-accounts-phone" type="text" value={form.accountsContactPhone} onChange={set('accountsContactPhone')} className="h-9 w-full rounded-md border border-[var(--color-card-border)] bg-transparent px-2.5 text-sm text-on-surface placeholder:text-on-surface-variant/60 focus:outline-none focus:border-white/25" />
            </Field>
          </div>
          <div className="grid grid-cols-2 gap-2">
            <Field label="Authorised Signatory Name" htmlFor="co-signatory-name">
              <input id="co-signatory-name" type="text" value={form.authorizedSignatoryName} onChange={set('authorizedSignatoryName')} className="h-9 w-full rounded-md border border-[var(--color-card-border)] bg-transparent px-2.5 text-sm text-on-surface placeholder:text-on-surface-variant/60 focus:outline-none focus:border-white/25" />
            </Field>
            <Field label="Authorised Signatory Title" htmlFor="co-signatory-title">
              <input id="co-signatory-title" type="text" value={form.authorizedSignatoryTitle} onChange={set('authorizedSignatoryTitle')} className="h-9 w-full rounded-md border border-[var(--color-card-border)] bg-transparent px-2.5 text-sm text-on-surface placeholder:text-on-surface-variant/60 focus:outline-none focus:border-white/25" />
            </Field>
          </div>
          <div className="grid grid-cols-2 gap-2">
            <Field label="Authorised Signatory Email" htmlFor="co-signatory-email">
              <input id="co-signatory-email" type="email" value={form.authorizedSignatoryEmail} onChange={set('authorizedSignatoryEmail')} className="h-9 w-full rounded-md border border-[var(--color-card-border)] bg-transparent px-2.5 text-sm text-on-surface placeholder:text-on-surface-variant/60 focus:outline-none focus:border-white/25" />
            </Field>
            <Field label="Authorised Signatory Phone" htmlFor="co-signatory-phone">
              <input id="co-signatory-phone" type="text" value={form.authorizedSignatoryPhone} onChange={set('authorizedSignatoryPhone')} className="h-9 w-full rounded-md border border-[var(--color-card-border)] bg-transparent px-2.5 text-sm text-on-surface placeholder:text-on-surface-variant/60 focus:outline-none focus:border-white/25" />
            </Field>
          </div>
          ...
          <Field label="Purchase Order Number" htmlFor="co-po-number">
            <input id="co-po-number" type="text" value={form.purchaseOrderNumber} onChange={set('purchaseOrderNumber')} className="h-9 w-full rounded-md border border-[var(--color-card-border)] bg-transparent px-2.5 text-sm text-on-surface placeholder:text-on-surface-variant/60 focus:outline-none focus:border-white/25" />
          </Field>
          <Field label="Invoice Instructions" htmlFor="co-invoice-instructions">
            <textarea id="co-invoice-instructions" value={form.invoiceInstructions} onChange={set('invoiceInstructions')} rows={3} className="w-full rounded-md border border-[var(--color-card-border)] bg-transparent p-2.5 text-sm text-on-surface placeholder:text-on-surface-variant/60 focus:outline-none focus:border-white/25 resize-none" />
          </Field>

          {/* Address */}
          <Section title="Address" />
          <Field label="Street" htmlFor="co-street">
            <input id="co-street" type="text" value={form.street} onChange={set('street')} className="h-9 w-full rounded-md border border-[var(--color-card-border)] bg-transparent px-2.5 text-sm text-on-surface placeholder:text-on-surface-variant/60 focus:outline-none focus:border-white/25" />
          </Field>
          <div className="grid grid-cols-2 gap-2">
            <Field label="City" htmlFor="co-city">
              <input id="co-city" type="text" value={form.city} onChange={set('city')} className="h-9 w-full rounded-md border border-[var(--color-card-border)] bg-transparent px-2.5 text-sm text-on-surface placeholder:text-on-surface-variant/60 focus:outline-none focus:border-white/25" />
            </Field>
            <Field label="State / Province" htmlFor="co-state">
              <input id="co-state" type="text" value={form.state} onChange={set('state')} className="h-9 w-full rounded-md border border-[var(--color-card-border)] bg-transparent px-2.5 text-sm text-on-surface placeholder:text-on-surface-variant/60 focus:outline-none focus:border-white/25" />
            </Field>
          </div>
          <div className="grid grid-cols-2 gap-2">
            <Field label="Country" htmlFor="co-country">
              <input id="co-country" type="text" value={form.country} onChange={set('country')} className="h-9 w-full rounded-md border border-[var(--color-card-border)] bg-transparent px-2.5 text-sm text-on-surface placeholder:text-on-surface-variant/60 focus:outline-none focus:border-white/25" />
            </Field>
            <Field label="Postal Code" htmlFor="co-postal">
              <input id="co-postal" type="text" value={form.postalCode} onChange={set('postalCode')} className="h-9 w-full rounded-md border border-[var(--color-card-border)] bg-transparent px-2.5 text-sm text-on-surface placeholder:text-on-surface-variant/60 focus:outline-none focus:border-white/25" />
            </Field>
          </div>
          ...
          <div className="grid grid-cols-2 gap-2">
            <Field label="Size" htmlFor="co-size">
              <select id="co-size" value={form.size} onChange={set('size')} className="h-9 w-full rounded-md border border-[var(--color-card-border)] bg-transparent px-2.5 text-sm text-on-surface placeholder:text-on-surface-variant/60 focus:outline-none focus:border-white/25">
            ...
            <Field label="Employee Count" htmlFor="co-emp">
              <input id="co-emp" type="number" min={0} value={form.employeeCount} onChange={set('employeeCount')} className="h-9 w-full rounded-md border border-[var(--color-card-border)] bg-transparent px-2.5 text-sm text-on-surface placeholder:text-on-surface-variant/60 focus:outline-none focus:border-white/25" />
            </Field>
          </div>
          <div className="grid grid-cols-2 gap-2">
            <Field label="Annual Revenue" htmlFor="co-rev">
              <input id="co-rev" type="number" min={0} value={form.annualRevenue} onChange={set('annualRevenue')} className="h-9 w-full rounded-md border border-[var(--color-card-border)] bg-transparent px-2.5 text-sm text-on-surface placeholder:text-on-surface-variant/60 focus:outline-none focus:border-white/25" />
            </Field>
            <Field label="Currency" htmlFor="co-currency">
              <input id="co-currency" type="text" value={form.currency} onChange={set('currency')} className="h-9 w-full rounded-md border border-[var(--color-card-border)] bg-transparent px-2.5 text-sm text-on-surface placeholder:text-on-surface-variant/60 focus:outline-none focus:border-white/25" placeholder="ZAR" />
            </Field>
          </div>
          <Field label="Tier" htmlFor="co-tier">
            <select id="co-tier" value={form.tier} onChange={set('tier')} className="h-9 w-full rounded-md border border-[var(--color-card-border)] bg-transparent px-2.5 text-sm text-on-surface placeholder:text-on-surface-variant/60 focus:outline-none focus:border-white/25">
          ...
          <Field label="Lifecycle Stage" htmlFor="co-lifecycle">
            <select id="co-lifecycle" value={form.lifecycleStage} onChange={set('lifecycleStage')} className="h-9 w-full rounded-md border border-[var(--color-card-border)] bg-transparent px-2.5 text-sm text-on-surface placeholder:text-on-surface-variant/60 focus:outline-none focus:border-white/25">
          ...
          <Field label="Notes" htmlFor="co-notes">
            <textarea
              ...
              onChange={set('notes')}
              rows={4}
              className="w-full rounded-md border border-[var(--color-card-border)] bg-transparent p-2.5 text-sm text-on-surface placeholder:text-on-surface-variant/60 focus:outline-none focus:border-white/25 resize-none"
        ...
        <div className="flex shrink-0 items-center justify-end gap-1.5 border-t border-[var(--color-card-border)] px-4 py-2.5">
          <button
            ...
            className="flex h-8 cursor-pointer items-center rounded-md border border-[var(--color-card-border)] px-3 text-xs text-on-surface-variant transition hover:bg-white/[0.05] hover:text-on-surface"
          >
            Cancel
          </button>
          <button
