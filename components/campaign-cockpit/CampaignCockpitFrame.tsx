...
import type { BrandColorsLike } from '@/lib/organizations/toPreviewBrand'

interface CampaignCockpitFrameProps {
...
export function campaignMonthLabel(value: unknown): string {
  if (!value) return ''
