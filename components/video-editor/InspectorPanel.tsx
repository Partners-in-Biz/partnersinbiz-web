...
export function InspectorPanel({
  ...
  return (
    <section className="pib-card-section space-y-3 p-4">
      <h2 className="font-headline text-lg font-semibold text-[var(--color-pib-text)]">Inspector</h2>
      ...
      />
      <div>
        <h3 className="text-sm font-semibold text-[var(--color-pib-text)]">Layout presets</h3>
