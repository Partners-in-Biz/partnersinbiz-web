  ...
  return (
    <Surface header={<h2 className="text-lg font-semibold">Assembly</h2>}>
      <div className="space-y-4">
        ...
        {error ? (
          <div className="space-y-2 rounded-2xl border border-red-200 bg-red-50 p-4 text-sm text-red-900" role="alert">
            <p>{error}</p>
        ...
        {manifest ? (
          <div className="space-y-3">
            <div className="flex flex-wrap items-center gap-2">
              <StatusPill tone="neutral">Version {manifest.version ?? '—'}</StatusPill>
