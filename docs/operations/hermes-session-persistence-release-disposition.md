...
The implementation source revision is `4f26a9a15f20b560b2100f4782787dbee662abf1` (`fix(session): preserve live tail during compression adoption`). The source project currently declares Hermes version 0.20.0; no signed Hermes release containing this hardening has been approved or published by this task.
