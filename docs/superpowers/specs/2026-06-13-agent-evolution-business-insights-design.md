...
- Still pending: richer CRM/SEO/ads/social/support signal adapters and live metric refreshers that populate `metadata.businessInsightAction.latest` from source systems.
