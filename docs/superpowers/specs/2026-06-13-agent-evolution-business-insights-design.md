...
- Still pending: broader live metric refreshers, deeper source coverage beyond the first CRM/support/social/ads/SEO metrics, and richer cost/token telemetry when the runtime stores exact usage numbers.
