...
- Still pending: source adapters for any future commercial modules not yet covered by CRM/support/social/ads/SEO/invoices/project-risk tasks, a trend dashboard for loop economics, and exact model token/cost telemetry when the model runtime exposes usage numbers.
