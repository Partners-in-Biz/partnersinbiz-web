...
**Editorial quality and reader experience model:** `docs/superpowers/specs/2026-06-08-book-studio-v1-editorial-quality-reader-experience-model.md`
...
- A Hermes skill contract pack defining copyable proposed contracts for the first Wave 1 and selected Wave 2 skills, including allowed inputs, required source keys, existing artifact requirements, outputs, forbidden actions, reviewer defaults, portal visibility, fixtures, stale-source behavior, and no-runtime flags.
...
- A launch and lifecycle governance model defining post-publication state, promotion and price gates, review/endorsement guardrails, revision invalidation, unpublish wording, portal-safe status, analytics caveats, and deferred Hermes launch boundaries.
- A market evidence and commercial selection model defining candidate pass/warn/block states, audience/buyer evidence, competitive shelf observations, discoverability metadata, book-family fit, rights, price/margin, channel fit, PiB strategic fit, Hermes boundaries, portal rules, and no sales/rank forecasting.
- An editorial quality and reader-experience model defining version-bound quality states, required quality lanes, family-specific quality traps, Hermes editorial boundaries, portal-safe quality summaries, analytics feedback caveats, and quality pass/warn/block fixtures.
- A language, translation, and edition governance model defining source/target language evidence, translation rights, translator/AI provenance, target-language quality, reading direction, metadata, identifiers, channel support, pricing/territory, portal safety, and analytics separation for translated editions.
- A production budget and capacity model defining budget states, human capacity, Hermes/model spend, proof costs, channel economics, break-even posture, launch-spend separation, portal safety, and budget pass/warn/block fixtures.
- A rights, asset, and contributor ledger model defining asset source, license scope, AI provenance, public-domain/open-license basis, client-owned asset approval, contributor credit/assignment evidence, portal-safe summaries, and pass/warn/block rights fixtures before production start, package QA, portal proof, launch copy, analytics promotion, or manual handoff.
- A metadata, discoverability, and store listing model defining channel-specific title/subtitle, description, KDP keywords/categories, Google genres, contributors, series, identifiers, language/translated-edition metadata, portal listing summaries, source refresh, and pass/warn/block listing fixtures.
...
| Create the book with Hermes agents. | The dossier defines Wave 1 planning/evidence skills, selected Wave 2 safety/readiness skills, Wave 3-5 later skills, skill manifests, allowed/forbidden outputs, fixture reports, reviewer defaults, and sanitizer expectations. The Hermes blueprint, evaluation packet, and contract pack now define per-skill input contracts, expected artifacts, pass/warn/block cases, forbidden regressions, portal visibility rules, source-key requirements, and no-runtime contract flags. The editorial quality model adds the rule that Hermes-assisted drafts cannot advance to package QA, portal proof, or packet readiness until the current version has reviewed quality pass or accepted-warning state. | Covered as controlled skill design; runtime dispatch remains gated. | Do not enable runtime Hermes dispatch until manifests, ledgers, sanitizers, fixture reports, forbidden-action tests, and quality gate invalidation exist. |
| Create new Hermes skills. | The dossier lists specific skill packages such as `book-niche-research`, `book-series-strategy`, `book-brief-builder`, `book-outline-builder`, KDP/Google readiness checks, metadata, account readiness, production/package/launch/analytics skills, and evaluation rubrics. The evaluation packet turns the first package into named fixture IDs and sanitizer expectations. The contract pack adds copyable proposed contract records for the first Wave 1 and selected Wave 2 skills. | Covered for skill design and pre-dispatch evaluation. | After approval, write skill specs and fixtures from the contract pack before runtime dispatch or client-visible output. |
...
| Govern launch, reviews, promotion, price changes, and post-publication lifecycle. | The launch/lifecycle governance model covers launch states, manual action evidence, KDP/Google promotion and price gates, review/endorsement guardrails, revision invalidation, unpublish wording, portal visibility, Hermes boundaries, and pass/warn/block launch fixtures. | Covered for design governance; runtime automation remains excluded. | Refresh official launch/review/promotion sources before planning any launch or lifecycle implementation task. |
| Play devil's advocate from all angles. | The dossier, approval packet, review script, acceptance fixtures, and red-team register include risk sections for policy drift, rights, AI disclosure, unsafe Hermes actions, client visibility, analytics overclaiming, direct publishing pressure, over-broad V1 scope, and polished weak AI-assisted books. The editorial quality model adds explicit `QUALITY-*` pass/warn/block cases. | Covered for design review. | Keep negative-control and quality-block fixtures in the future demo set unless Peet explicitly removes them and accepts weaker blocker proof. |
...
| Select commercially sensible book candidates before production. | The pilot decision register says market demand requires a future Research packet. The market evidence model now defines that packet's pass/warn/block lanes for reader/buyer use case, competitive shelf, metadata, family fit, differentiation, rights, channel fit, price/margin, PiB fit, and capacity. | Covered for V1 design. | Do not let Hermes or operators move an idea into Book Brief, production, client promise, sales forecast, or rank promise without reviewed market evidence. |
| Govern metadata, discoverability, and store listing claims. | The metadata/listing model defines separate KDP and Google lanes for title/subtitle, description, keywords, categories, genres, contributors, series, identifiers, language/translation metadata, portal listing summaries, source freshness, Hermes boundaries, and `META-*` pass/warn/block cases. | Covered as a design gate. | Do not let packet readiness, portal listing summaries, launch copy, analytics promotion, or client-visible listing claims proceed with keyword stuffing, misleading categories/genres, copied competitor metadata, KDP/Google flattening, unsupported contributor/series/identifier state, or rank/sales/bestseller promises. |
| Govern production cost, capacity, and budget before work starts. | The production budget and capacity model defines budget states, required cost lanes, human capacity, Hermes/model run budgets, proof costs, channel economics, break-even posture, launch-spend separation, portal safety, and `BUDGET-*` fixtures. | Covered as a design gate. | Do not move a candidate from production-selectable to production-started without approved or accepted-warning budget and capacity evidence. |
| Govern asset permissions, contributor authority, and rights evidence before production artifacts move forward. | The rights, asset, and contributor ledger model defines evidence lanes for manuscripts, covers, interior assets, fonts, templates, quotes, public-domain/open-licensed material, AI-generated assets, client-owned brand assets, translators, illustrators, designers, narrators, and other contributors. | Covered as a design gate. | Do not let production start, package QA, portal proof, launch copy, analytics promotion, or manual handoff proceed with missing, stale, or disputed rights evidence. |
...
| Govern translated editions and language variants. | The language/translation model separates source language, target language, translation rights, AI or translator provenance, edition identity, target metadata, identifiers, reading direction/layout, target-language QA, channel support, pricing/territory, portal summaries, and analytics by edition. | Covered as a design gate; translated-edition production remains excluded from V1 until approved. | Refresh KDP/Google language and translation sources before planning any translation production, Kindle Translate pathway, Google translated-edition packet, portal proof, or manual-handoff task. |
...
The current research dossier contains a current-source addendum dated 2026-06-08. The source refresh contract adds a standalone evidence rule set for keeping those policy claims current. The book-family gate catalog turns the broad "all book types" requirement into concrete profile rules. The ownership/commercial model adds the account-authority and economics review surface. The market evidence model turns "this book idea is worth producing" into a source-backed pass/warn/block decision instead of a creative prompt, shelf screenshot, sales forecast, or Hermes-generated promise. The metadata/listing model turns "this book can be listed" into a channel-specific title/subtitle, description, keyword, category, genre, contributor, series, identifier, language, and portal-summary gate rather than keyword stuffing, copied competitor metadata, KDP/Google flattening, or rank promises. The production budget and capacity model turns "we should make this" into a version-bound budget/capacity decision with human capacity, Hermes/model spend, proof costs, channel economics, break-even posture, launch-spend separation, portal safety, and budget fixtures. The editorial quality model turns "this manuscript exists" into a version-bound pass/warn/block review across reader promise, structure, originality, claims, editorial quality, continuity, usability, accessibility, rights-sensitive content, and client-safe summaries. The language/translation model turns "translate this book" into a source-target edition governance decision with rights, provenance, target-language quality, reading direction, metadata, identifier, channel, pricing, portal, and analytics gates. The rights, asset, and contributor ledger model turns "we have the files and people" into asset-level and contributor-level pass/warn/block evidence for source, license scope, AI provenance, public-domain/open-license basis, client-owned assets, contributor credit, assignment/license, territory, format, and channel. The mock review packet makes the pass/warn/block operating loop concrete. The review scorecard makes the final approval decision auditable across product posture, channels, pilots, Hermes, publishing, account authority, local publisher evidence, package QA, portal exposure, analytics, `ai-story`, operator workflow, and devil's-advocate categories. The pilot product decision register makes the first book-product choice explicit while preserving the rule that market demand belongs in a future Research evidence packet. The revision impact matrix makes "approve with revisions" auditable by naming the affected evidence docs, source refresh triggers, and blockers before any plan exists. The wider-channel adapter packet keeps Apple/Kobo/D2D/Ingram/audio future-compatible while preserving the KDP/Google V1 boundary. The portal access and promotion model makes client-safe visibility and module enablement explicit. The domain record/state model names the conceptual records, relationships, state machines, and invalidation triggers a future plan must preserve. The operator workspace control model describes how admins should operate the module through staged commands and PiB bridges instead of a blank AI prompt. The production package QA model binds proof, file, cover, rights, accessibility, and checksum evidence to manual-handoff readiness. The jurisdiction/local publisher model prevents KDP/Google readiness from being mistaken for South African legal-deposit, ISBN/imprint, copyright, contributor, or local publisher readiness. The launch/lifecycle governance model keeps post-publication operations bounded by review compliance, price/promotion approval, manual action evidence, revision invalidation, unpublish wording, safe portal summaries, and no autonomous public or ad activity. The `ai-story` non-port checklist keeps the prior project useful as UX evidence while blocking standalone ownership, browser-key, broad-agent, and policy-source shortcuts. Together, they are enough for a design decision today, but not enough to make future implementation or upload-ready claims without refresh and approval.
...
- Any packet-readiness, portal listing summary, launch copy, or analytics-promotion claim that depends on title/subtitle, description, keywords, categories, genres, contributors, series, identifiers, language, translated-edition metadata, or channel listing posture must pass or carry accepted metadata/listing warnings first.
- Any generated or assisted manuscript/proof must pass or carry accepted editorial quality warnings before package QA, portal proof, or publishing packet readiness.
- Any translated edition must pass language and translation lanes before package QA, portal proof, publishing packet readiness, manual handoff, or translated-edition analytics promotion.
- Any production-selected candidate must pass or carry accepted production budget and capacity warnings before production starts, Hermes/model spend is incurred, proof costs are committed, portal production promises are made, or launch spend is proposed.
- Any asset, quote, font, template, public-domain/open-licensed material, AI-generated asset, client-owned brand asset, or contributor input must pass or carry accepted rights-ledger warnings before dependent production start, package QA, portal proof, launch copy, analytics promotion, or manual handoff.
...
- Runtime Hermes skill files, manifests, fixture runners, sanitizer implementation, or dispatch records.
...
- Runtime metadata optimizers, category automation, keyword scraping, listing mutation, or direct KDP/Google listing updates.
- Runtime Hermes dispatch from the app.
- Translation engine work, translated-edition production, Kindle Translate automation, or Google translated-edition handoff.
- Runtime production budget ledgers, cost calculators, billing flows, cost-recovery automation, or budget approval workflows.
...
- If runtime Hermes dispatch is treated as the first milestone, polished unsafe output will arrive before PiB has the evidence ledger, contract pack, sanitizers, and forbidden-action tests needed to govern it.
