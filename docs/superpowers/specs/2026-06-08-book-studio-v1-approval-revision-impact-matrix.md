...
- Keep packet readiness, portal listing summaries, launch copy, and analytics promotion blocked until metadata/listing evidence reaches pass or accepted warning for the affected KDP/Google/title/description/category/keyword/genre/contributor/series/identifier/language scope.
...
| `metadataListingScope` | Start with KDP/Google manual-handoff metadata only; require portal listing summary review; add stricter no-stuffing/no-copy/no-rank blocker. | KDP title/subtitle, description, keywords, categories, authors/contributors, series, content-quality, and Google title/subtitle, genres, contributors, identifiers, series, content-policy, language, translated-edition, portal-summary, and rights-source evidence. | Approval packet, metadata/listing model, source refresh contract, source refresh execution report, acceptance fixtures, review script, publishing/analytics model, domain record/state model, coverage audit. | Packet readiness, portal listing summary, launch copy, or analytics promotion can bypass misleading metadata, keyword stuffing, copied competitor copy, unsupported contributor/series/identifier state, KDP/Google flattening, or rank/sales/bestseller promises. | Metadata looks like copywriting, but it is where customer trust, channel policy, rights, contributor, series, and analytics meaning converge. |
