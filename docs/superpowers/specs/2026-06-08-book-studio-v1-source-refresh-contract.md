...
**Metadata/listing source aid:** `docs/superpowers/specs/2026-06-08-book-studio-v1-metadata-discoverability-listing-model.md`
...
The metadata/listing model adds a channel-specific listing gate for KDP title/subtitle, description, keywords, categories, contributors, series, and Google title/subtitle, description, genres, contributors, identifiers, series, and content-policy posture. These keys govern packet readiness, portal listing summaries, launch copy, and analytics promotion; they do not approve keyword scraping, category automation, live listing mutation, copied competitor copy, or rank promises.
...
- KDP title/subtitle, description, keyword, category, author/contributor, and series metadata still supports a channel-specific listing gate rather than live listing mutation, copied competitor metadata, or rank/sales promises.
...
| Metadata/listing approval | Recheck KDP keywords, categories, metadata, description, authors/contributors, series, content-quality, and Google metadata, add-book, series, identifiers, and content-policy sources before packet readiness, portal listing summaries, launch copy, or analytics promotion. | Metadata remains collecting, reviewable-with-warning, or blocked; no upload-ready, portal listing-ready, launch-copy-ready, or analytics-promoted claim is allowed for the affected channel/scope. |
...
| Metadata/listing packet or portal claim | KDP/Google source behind title/subtitle, description, keywords, categories, genres, contributors, series, identifiers, language, translated-edition metadata, or content-policy posture. | Internal option drafting, reviewer questions, and safe blocker wording; no packet-ready, portal listing-ready, launch-copy-ready, or analytics-promoted claim. |
