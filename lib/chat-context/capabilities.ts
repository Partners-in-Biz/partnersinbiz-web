...
export const CHAT_CONTEXT_CAPABILITIES = {
  ...
  contact: descriptor('contact', { domain: 'crm', label: 'Contact', adapterLevel: 'canonical', actionLevel: 'navigate', authoritativeSource: 'CRM contacts', recommendedAgentIds: ['sales', 'nora', 'pip'] }),
  company: descriptor('company', { domain: 'crm', label: 'Company', adapterLevel: 'canonical', actionLevel: 'navigate', authoritativeSource: 'CRM companies', recommendedAgentIds: ['sales', 'nora', 'pip'] }),
  ...
  document: descriptor('document', { domain: 'knowledge', label: 'Document', adapterLevel: 'canonical', actionLevel: 'navigate', authoritativeSource: 'Client Documents', recommendedAgentIds: ['docs', 'pip', 'nora'] }),
  ...
  deal: descriptor('deal', { domain: 'crm', label: 'Deal', adapterLevel: 'canonical', actionLevel: 'navigate', authoritativeSource: 'CRM deals', recommendedAgentIds: ['sales', 'nora', 'data'] }),
  invoice: descriptor('invoice', { domain: 'commerce', label: 'Invoice', adapterLevel: 'canonical', actionLevel: 'navigate', authoritativeSource: 'Invoicing', recommendedAgentIds: ['nora', 'data', 'pip'] }),
  quote: descriptor('quote', { domain: 'commerce', label: 'Quote', adapterLevel: 'canonical', actionLevel: 'navigate', authoritativeSource: 'Quotes', recommendedAgentIds: ['sales', 'nora', 'docs'] }),
  ...
  seo_sprint: descriptor('seo_sprint', { domain: 'marketing', label: 'SEO sprint', adapterLevel: 'canonical', actionLevel: 'navigate', authoritativeSource: 'SEO sprints', recommendedAgentIds: ['seo', 'sage', 'data'] }),
