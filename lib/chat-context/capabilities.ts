...
export const CHAT_CONTEXT_CAPABILITIES = {
  ...
  research: descriptor('research', { domain: 'knowledge', label: 'Research', adapterLevel: 'specialized', actionLevel: 'inline', authoritativeSource: 'Research workspace', recommendedAgentIds: ['sage', 'data', 'docs'] }),
  ...
  property: descriptor('property', { domain: 'operations', label: 'Property', adapterLevel: 'specialized', actionLevel: 'inline', authoritativeSource: 'Properties', recommendedAgentIds: ['nora', 'data', 'pip'] }),
  ...
  workspace_connection: descriptor('workspace_connection', { domain: 'workspace', label: 'Workspace connection', adapterLevel: 'canonical', actionLevel: 'inline', authoritativeSource: 'Workspace connections', recommendedAgentIds: ['nora', 'pip', 'support'] }),
