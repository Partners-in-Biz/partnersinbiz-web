...
export const CHAT_CONTEXT_CAPABILITIES = {
  ...
  research: descriptor('research', { domain: 'knowledge', label: 'Research', adapterLevel: 'specialized', actionLevel: 'navigate', authoritativeSource: 'Research workspace', recommendedAgentIds: ['sage', 'data', 'docs'] }),
  ...
  email: descriptor('email', { domain: 'communications', label: 'Email', adapterLevel: 'specialized', actionLevel: 'inline', authoritativeSource: 'Mailbox', recommendedAgentIds: ['sales', 'support', 'nora'] }),
  support: descriptor('support', { domain: 'communications', label: 'Support ticket', adapterLevel: 'specialized', actionLevel: 'inline', authoritativeSource: 'Support queue and ticket messages', recommendedAgentIds: ['support', 'pip', 'theo'] }),
  ...
  property: descriptor('property', { domain: 'operations', label: 'Property', adapterLevel: 'specialized', actionLevel: 'navigate', authoritativeSource: 'Properties', recommendedAgentIds: ['nora', 'data', 'pip'] }),
  ...
  workspace_artifact: descriptor('workspace_artifact', { domain: 'workspace', label: 'Workspace artifact', adapterLevel: 'specialized', actionLevel: 'inline', authoritativeSource: 'Workspace artifact ledger', recommendedAgentIds: ['docs', 'pip', 'theo'] }),
  ...
  workspace_broker_job: descriptor('workspace_broker_job', { domain: 'workspace', label: 'Workspace broker job', adapterLevel: 'specialized', actionLevel: 'inline', authoritativeSource: 'Workspace broker', recommendedAgentIds: ['pip', 'theo', 'support'] }),
  ...
  file: descriptor('file', { domain: 'knowledge', label: 'File', adapterLevel: 'specialized', actionLevel: 'navigate', authoritativeSource: 'Uploads', recommendedAgentIds: ['docs', 'pip', 'theo'] }),
  report: descriptor('report', { domain: 'knowledge', label: 'Report', adapterLevel: 'specialized', actionLevel: 'navigate', authoritativeSource: 'Reports', recommendedAgentIds: ['data', 'sage', 'docs'] }),
