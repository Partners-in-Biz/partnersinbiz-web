...
export const MODEL_REGISTRY: CanonicalModelEntry[] = [
  ...
  { id: 'x-ai/grok-4.5', label: 'Grok 4.5 (OpenRouter)', provider: 'openrouter', providerKeys: ['openrouter'], runtimeCompatible: false, agentTaskRestriction: { code: 'chat-only', reason: 'OpenRouter-prefixed models are not supported by Hermes agent runtimes.' } },
