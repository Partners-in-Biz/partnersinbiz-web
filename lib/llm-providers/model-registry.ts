...
export const MODEL_REGISTRY: CanonicalModelEntry[] = [
  ...
  { id: 'deepseek/deepseek-v4-flash-0731', label: 'DeepSeek V4 Flash 0731 (Nous Portal)', provider: 'nous', providerKeys: ['nous'], runtimeCompatible: false, agentTaskRestriction: { code: 'chat-only', reason: 'Nous Portal models are available for chat selection but are not offered for agent-task dispatch.' } },
